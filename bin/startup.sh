#!/bin/bash
export JAVA_HOME=/usr/java/jdk1.8.0_60              ###jdk安装路径
java=$JAVA_HOME/bin/java

JAVA_OPTS=$JAVA_OPTS:"-Xms1024m -Xmx1024m"
export JAVA_OPTS

SERVER_HOME=/opt/silent                     ###放置lib文件夹和shell的目录
...
export CLASSPATH
exec $java com.yaochufa.jframework.nutch.AppStarter $* >logs/stdout.log 2>&1 &